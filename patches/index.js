...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.defaultMetadata = exports.SmsTemplateType = exports.staticConfigs = exports.endpoint = void 0;
exports.endpoint = 'https://dysmsapi.aliyuncs.com/';
exports.staticConfigs = {
    Format: 'json',
...
(function (SmsTemplateType) {
    ...
    SmsTemplateType[SmsTemplateType["Passcode"] = 2] = "Passcode";
...
const utils_1 = __nccwpck_require__(3080);
/**
 * @doc https://help.aliyun.com/document_detail/101414.html
 */
const sendSms = async (parameters, accessKeySecret) => {
    return (0, utils_1.request)(constant_1.endpoint, { Action: 'SendSms', ...constant_1.staticConfigs, ...parameters }, accessKeySecret);
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.aliyunSmsConfigGuard = exports.sendSmsResponseGuard = void 0;
const zod_1 = __nccwpck_require__(6319);
const constant_1 = __nccwpck_require__(2124);
exports.sendSmsResponseGuard = zod_1.z.object({
    BizId: zod_1.z.string().optional(),
    Code: zod_1.z.string(),
...
const templateGuard = zod_1.z.object({
    type: zod_1.z.nativeEnum(constant_1.SmsTemplateType).default(2),
    usageType: zod_1.z.string(),
    templateCode: zod_1.z.string(),
    intlTemplateCode: zod_1.z.string(),
});
exports.aliyunSmsConfigGuard = zod_1.z.object({
    accessKeyId: zod_1.z.string(),
    accessKeySecret: zod_1.z.string(),
    signName: zod_1.z.string(),
    templates: zod_1.z.array(templateGuard).refine((templates) => requiredTemplateUsageTypes.every((requiredType) => templates.map((template) => template.usageType).includes(requiredType)), (templates) => ({
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.request = exports.getSignature = void 0;
const crypto_1 = __nccwpck_require__(6113);
const got_1 = __importDefault(__nccwpck_require__(9235));
...
const getSignature = (parameters, secret, method) => {
    ...
    return (0, crypto_1.createHmac)('sha1', `${secret}&`).update(stringToSign).digest('base64');
};
...
const request = async (url, parameters, accessKeySecret) => {
    ...
    const signature = (0, exports.getSignature)(finalParameters, accessKeySecret, 'POST');
...
const got_1 = __nccwpck_require__(9235);
const constant_1 = __nccwpck_require__(2124);
const single_send_text_1 = __nccwpck_require__(945);
...
const sendMessage = (getConfig) => async (data, inputConfig) => {
    ...
    (0, connector_kit_1.validateConfig)(config, types_1.aliyunSmsConfigGuard);
    const { accessKeyId, accessKeySecret, signName, templates } = config;
    const template = templates.find(({ usageType }) => usageType === type);
    (0, essentials_1.assert)(template, new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.TemplateNotFound, `Cannot find template!`));
    try {
        const httpResponse = await (0, single_send_text_1.sendSms)({
        ...
        if (Code !== 'OK') {
            throw new connector_kit_1.ConnectorError(connector_kit_1.ConnectorErrorCodes.General, {
...
const parseResponseString = (response) => {
    const result = types_1.sendSmsResponseGuard.safeParse((0, connector_kit_1.parseJson)(response));
    if (!result.success) {
...
const createAliyunSmsConnector = async ({ getConfig }) => {
    return {
        ...
        configGuard: types_1.aliyunSmsConfigGuard,
        sendMessage: sendMessage(getConfig),
    };
};
exports["default"] = createAliyunSmsConnector;
